...
class CineyPyayController extends Controller
{

public function createOrderBiling()   {


$apiKey = "385835965629a9f28b4bb59.80201951"; //Veuillez entrer votre apiKey
$site_id = "987464"; //Veuillez entrer votre siteId
...
$montant_a_payer = 400 ; // Montant à Payer : minimun est de 100 francs sur CinetPay
...
$return_url = 'localhost:8000'; // Lien de retour CallBack CinetPay
$cancel_url = 'localhost:8000'; // Lien d'annulation CinetPay
